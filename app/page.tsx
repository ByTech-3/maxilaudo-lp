      ...
      <section className="bg-white py-[88px]" id="servicos">
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
            {([
              { tag: "★ Produto Principal", title: "MAXILAUDO — Laudo Cautelar", desc: "Perícia completa antes de comprar. O produto que protege seu investimento — análise estrutural, mecânica, documental e de pintura.", href: "/maxilaudo" },
